...
def createFile(increment):
    return f"""\
        ---
        title: This is Trash Post {increment}
        slug: trash-posting-{increment}
        author: Christopher Digno
        created_at: {random.randint(1, 30)}-{random.randint(1, 12)}-{random.randint(2020, 2025)}
        read_time_minutes: 5
        tags:
            - markdown
            - testing
